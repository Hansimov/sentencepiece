...
class TrainerSpec PROTOBUF_FINAL :
 ...
 public:
  ...
  // optional bool split_alphanum = 60 [default = false];
  bool has_split_alphanum() const;
  private:
  bool _internal_has_split_alphanum() const;
  public:
  void clear_split_alphanum();
  bool split_alphanum() const;
  void set_split_alphanum(bool value);
  private:
  bool _internal_split_alphanum() const;
  void _internal_set_split_alphanum(bool value);
  public:
...
// optional bool split_alphanum = 60 [default = false];
inline bool TrainerSpec::_internal_has_split_alphanum() const {
  bool value = (_has_bits_[0] & 0x00400000u) != 0;
  return value;
}
inline bool TrainerSpec::has_split_alphanum() const {
  return _internal_has_split_alphanum();
}
inline void TrainerSpec::clear_split_alphanum() {
  split_alphanum_ = false;
  _has_bits_[0] &= ~0x00400000u;
}
inline bool TrainerSpec::_internal_split_alphanum() const {
  return split_alphanum_;
}
inline bool TrainerSpec::split_alphanum() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.split_alphanum)
  return _internal_split_alphanum();
}
inline void TrainerSpec::_internal_set_split_alphanum(bool value) {
  _has_bits_[0] |= 0x00400000u;
  split_alphanum_ = value;
}
inline void TrainerSpec::set_split_alphanum(bool value) {
  _internal_set_split_alphanum(value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.split_alphanum)
}
