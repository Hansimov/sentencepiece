...
class TrainerSpec::_Internal {
 public:
  ...
  static void set_has_split_alphanum(HasBits* has_bits) {
    (*has_bits)[0] |= 4194304u;
  }
};
...
// @@protoc_insertion_point(message_clear_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x00ff0000u) {
    ::memset(&allow_whitespace_only_pieces_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&differential_privacy_noise_level_) -
        reinterpret_cast<char*>(&allow_whitespace_only_pieces_)) + sizeof(differential_privacy_noise_level_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 60:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 224)) {
          _Internal::set_has_split_alphanum(&_has_bits_);
          split_alphanum_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* TrainerSpec::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00400000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(60, this->_internal_split_alphanum(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x00ff0000u) {
    ...
    if (cached_has_bits & 0x00400000u) {
      split_alphanum_ = from.split_alphanum_;
    }
    if (cached_has_bits & 0x00800000u) {
